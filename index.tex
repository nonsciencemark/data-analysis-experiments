...
\citeproc{ref-Sohm2016}{Sohm et al. 2016}). The ciliate genera represent
globally-distributed mixotrophs (\citeproc{ref-Weisse2022}{Weisse and
Montagnes 2022}; \citeproc{ref-Lu2021}{Lu, Gao, and Weisse 2021}) and
\emph{Synechococcus} makes up a substantial proportion of marine
phytoplankton biomass and photosynthesis
(\citeproc{ref-Dvorak2014}{Dvořák et al. 2014}).
...
(\citeproc{ref-Pennekamp2014}{Pennekamp et al. 2014}). The traits were
...
{\centering \includegraphics[width=4in,height=\textheight]{figures/cilia/cilia_td_general.pdf}
...
{\centering \includegraphics[width=4in,height=\textheight]{figures/cyano/cyano_td_general.pdf}
...
frame of our experiment (\citeproc{ref-Stomp2004}{Stomp et al. 2004}).
...
growth (\citeproc{ref-Maranon2015}{Marañón 2015};
\citeproc{ref-Stomp2007a}{Stomp et al. 2007}). In contrast, the ciliate
...
(\citeproc{ref-Kiorboe1995}{Kiørboe and Saiz 1995};
\citeproc{ref-Jacob2019}{Jacob et al. 2019}).
...
{\centering \includegraphics[width=4in,height=\textheight]{figures/cilia/cilia_pcgr.pdf}
...
{\centering \includegraphics[width=4in,height=\textheight]{figures/cyano/cyano_pcgr.pdf}
...
{\centering \includegraphics[width=4in,height=\textheight]{figures/cilia/cilia_dT.pdf}
...
{\centering \includegraphics[width=4in,height=\textheight]{figures/cyano/cyano_dT.pdf}
...
{\centering \includegraphics{figures/cilia/cilia_growth_dtrait.pdf}
...
{\centering \includegraphics{figures/cyano/cyano_growth_dtrait.pdf}
...
{\centering \includegraphics{figures/cilia/cilia_R2.pdf}
...
{\centering \includegraphics{figures/cyano/cyano_R2.pdf}
