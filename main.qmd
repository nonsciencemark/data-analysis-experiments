...
- **justify the ciliate genera selection and how these choices could affect the results.**
- **phylogeny of syn vs cilia**
...
- **also why the stressors that we chose?**
...
- **nicer figures and captions and discussion is a bit brief**
...
![As @fig-cilia_td_general, but for four strains of the cyanobacteria genus *Synechococcus*.](figures/cyano/cyano_td_general.pdf){#fig-cyano_td_general width="4in"}

- **maybe 5.1 and 5.2 are too big and complicated for the benefit that they give**
- **needs more detail - how do the traits change over time and how do these affect growth?**
- **are density and traits correlated? etc.**
- **Population size for Synechoccocus is very high so more capacity for evolution.**
- **how do the cells, at a metabolic level, deal with atrazine (rather than how are they affected by atrazine)?**
- **think a bit more deeply about the traits measured and how do they adapt to the conditions.**
...
- **why ciliates are "less mechanistic"? explain more in-text**
