...
al. 2004}) and it is likely that larger changes to the environment will
only increase the importance of trait information. How the reciprocal
effects (of density on traits) differ between systems is less intuitive,
however, and will depend on the capacity and speed of the trait change.
