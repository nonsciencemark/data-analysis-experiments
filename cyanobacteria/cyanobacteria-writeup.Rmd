...
# Load data
in.data <- readRDS('C:/Users/mholmes/Documents UNamur/Lab work/03_Experiments/15_2022-06_DIVERCE/mono_data_clean.RData') %>%
...
# View raw data
ggplot(in.data, aes(x = date, y = population, col = strain)) + 
