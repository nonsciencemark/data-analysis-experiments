...
correlation. However, I observed a positive correlation. That is why I conduct a pca below with all traits so see how they relate to each other. Initially I included all means and sd of speed, linearity, area and aspect ratio (ar) as well as density (Parts_permL), culture age (Days_fromstart) and per capita growth rate (pcgr).
...
Traj.avg <- read.csv("ciliates/OverviewTraitsFull.csv") %>%
...
Now create a PCA with all variables included:
