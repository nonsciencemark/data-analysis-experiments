...
(Table~\ref{tbl-treatment-table}, \textbf{?@sec-sampling-times}).
...
and negative density-dependence (\textbf{?@fig-cilia-td-general},
\textbf{?@fig-cyano-td-general}). Intrinsic growth rates of
...
(\textbf{?@fig-cyano-pcgr}). However, environmental conditions had
...
(\textbf{?@fig-cilia-td-general}, \textbf{?@fig-cyano-td-general}). In
the ciliate system, intrinsic trait change (\textbf{?@fig-cilia-dT}) was
generally not significantly different from zero, but estimates varied
across environmental conditions in \emph{Tetrahymena} strains. The
trait-dependence of trait change in ciliates was also strongest for
...
(\textbf{?@fig-cyano-R2}). Furthermore, trait dynamics in the
