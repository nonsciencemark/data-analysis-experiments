...
![Density-dependence of ciliate per-capita growth rate in the different treatments.](figures/cilia/cilia_pcgr.pdf){#fig-cilia_pcgr width="4in"}

### Cyanobacteria

![As @fig-cilia_pcgr but for the cyanobacteria system](figures/cyano/cyano_pcgr.pdf){#fig-cyano_pcgr width="4in"}

## Trait values and trait change

### Ciliate

![Trait-dependence of ciliate trait change in the different treatments.](figures/cilia/cilia_dT.pdf){#fig-cilia_dT width="4in"}

### Cyanobacteria

![As @fig-cilia_dT but the cyanobacteria system.](figures/cyano/cyano_dT.pdf){#fig-cyano_dT width="4in"}
